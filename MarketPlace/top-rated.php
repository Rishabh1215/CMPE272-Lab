...
$query2 = "SELECT * FROM review  where domain = '$domains[1]' group by productName order by rating desc limit 5";
$result2 = $mysqli->query($query2);

$query3 = "SELECT * FROM review  where domain = '$domains[2]' group by productName order by rating desc limit 5";
$result3 = $mysqli->query($query3);

$query4 = "SELECT * FROM review  where domain = '$domains[3]' group by productName order by rating desc limit 5";
$result4 = $mysqli->query($query4);

$globalQuery = "SELECT * FROM review order by rating desc limit 5";
$gloablResult = $mysqli->query($globalQuery);

?>

<center>
  <h2 style="color: #777; margin-bottom: 2rem; margin-top: 2rem;">Top Rated</h2>
</center>
  ...
  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    <div class="panel panel-default">
      <div class="panel-heading active" role="tab" id="headingOne">
        <h4 class="panel-title">
          <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            Top 5 top rated items from <?php echo $domains[0] ?>
          </a>
        </h4>
      </div>
      <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      ...
      <div class="panel-heading active" role="tab" id="headingTwo">
        <h4 class="panel-title">
          <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            Top 5 top rated items from <?php echo $domains[1] ?>
          </a>
        </h4>
      </div>
      ...
      <div class="panel-heading active" role="tab" id="headingThree">
        <h4 class="panel-title">
          <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
            Top 5 top rated items from <?php echo $domains[2] ?>
          </a>
        </h4>
      </div>
      ...
      <div class="panel-heading active" role="tab" id="headingFour">
        <h4 class="panel-title">
          <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
            Top 5 top rated items from <?php echo $domains[3] ?>
          </a>
        </h4>
      </div>
